...
5-In another terminal, run your scan filter node (better use args see below):
...
7-you can use this to see the stats:
ros2 run scan_filter scan_filter_stats 
add it in rviz as well

8-to see a plat use this:
 ros2 run scan_filter filter_plot 

9-to save your filtering as a gif , cd to the scan filter folder and use this:
python3 save_scan.py 


10- we can also use a live scan plot by using this:
python3 live_scan_plot.py 
